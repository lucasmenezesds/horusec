...
<<<<<<< HEAD:development-kit/pkg/engines/leaks/analysis/analysis_test.go
		assert.Equal(t, len(data), 19)
=======
		assert.Equal(t, 6, len(data))
>>>>>>> 538d56d31687b4cbea77d421b2708a24be39bbb7:horusec-leaks/internal/controllers/analysis_test.go
	})
