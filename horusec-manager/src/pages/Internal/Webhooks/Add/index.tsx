...
const AddWebhook: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    fetchRepositories();
<<<<<<< HEAD:horusec-manager/src/pages/Internal/Home/Webhooks/Add/index.tsx
  }, [companyID]);
=======
  }, [currentWorkspace]);
>>>>>>> 538d56d31687b4cbea77d421b2708a24be39bbb7:horusec-manager/src/pages/Internal/Webhooks/Add/index.tsx
